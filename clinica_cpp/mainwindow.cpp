...
=======
        ui->tw_pacientes->setColumnWidth(1, 280);
        ui->tw_pacientes->setColumnWidth(2, 40);
        ui->tw_pacientes->setColumnWidth(3, 130);
        ui->tw_pacientes->setColumnWidth(4, 115);
        ui->tw_pacientes->setColumnWidth(5, 175);
...
{
    int linha = ui->tw_pacientes->currentRow();
    int id = ui->tw_pacientes->item(ui->tw_pacientes->currentRow(), 0)->text().toInt();
>>>>>>> 762b877 (Night update)
