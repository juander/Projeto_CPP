...
public:
    ...
    QLabel *label_8;
    QLineEdit *linePesquisa;
    QTableWidget *tw_pacientes;
    QHBoxLayout *horizontalLayout_2;
    QPushButton *btnApagarPac;
    QPushButton *btnEditarPac;
    QSpacerItem *horizontalSpacer;
    QWidget *Colaboradores;
    QWidget *layoutWidget_2;
    QVBoxLayout *verticalLayout_2;
    QHBoxLayout *horizontalLayout_3;
    QPushButton *btnCadastro_2;
    QSpacerItem *horizontalSpacer_3;
    QLabel *label_12;
    QLineEdit *linePesquisa_2;
    QTableWidget *tw_colaboradores;
    QHBoxLayout *horizontalLayout_4;
    QPushButton *btnApagarCol;
    QPushButton *btnEditarCol;
...
"color: rgb(255, 255, 255);"));
        ...
        btnProfissionais->setText(QString::fromUtf8("Colaboradores"));
        QIcon icon2;
...
""));
        ...
        linePesquisa = new QLineEdit(layoutWidget);
        linePesquisa->setObjectName("linePesquisa");

        horizontalLayout->addWidget(linePesquisa);
        ...
        Colaboradores = new QWidget();
        Colaboradores->setObjectName("Colaboradores");
        layoutWidget_2 = new QWidget(Colaboradores);
        layoutWidget_2->setObjectName("layoutWidget_2");
        layoutWidget_2->setGeometry(QRect(10, 20, 1091, 641));
        verticalLayout_2 = new QVBoxLayout(layoutWidget_2);
        verticalLayout_2->setObjectName("verticalLayout_2");
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        btnCadastro_2 = new QPushButton(layoutWidget_2);
        btnCadastro_2->setObjectName("btnCadastro_2");
        btnCadastro_2->setStyleSheet(QString::fromUtf8(""));

        horizontalLayout_3->addWidget(btnCadastro_2);
        ...
        linePesquisa_2 = new QLineEdit(layoutWidget_2);
        linePesquisa_2->setObjectName("linePesquisa_2");

        horizontalLayout_3->addWidget(linePesquisa_2);


        verticalLayout_2->addLayout(horizontalLayout_3);

        tw_colaboradores = new QTableWidget(layoutWidget_2);
        tw_colaboradores->setObjectName("tw_colaboradores");

        verticalLayout_2->addWidget(tw_colaboradores);

        horizontalLayout_4 = new QHBoxLayout();
        horizontalLayout_4->setObjectName("horizontalLayout_4");
        btnApagarCol = new QPushButton(layoutWidget_2);
        btnApagarCol->setObjectName("btnApagarCol");

        horizontalLayout_4->addWidget(btnApagarCol);

        btnEditarCol = new QPushButton(layoutWidget_2);
        btnEditarCol->setObjectName("btnEditarCol");

        horizontalLayout_4->addWidget(btnEditarCol);
        ...
        paginas->addTab(Colaboradores, QString());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnCadastro_2->setText(QCoreApplication::translate("MainWindow", "Cadastrar colaborador", nullptr));
        label_12->setText(QCoreApplication::translate("MainWindow", "Pesquisar colaborador:", nullptr));
        linePesquisa_2->setText(QString());
        btnApagarCol->setText(QCoreApplication::translate("MainWindow", "Apagar", nullptr));
        btnEditarCol->setText(QCoreApplication::translate("MainWindow", "Editar", nullptr));
        paginas->setTabText(paginas->indexOf(Colaboradores), QCoreApplication::translate("MainWindow", "Page", nullptr));
