...
public:
    ...
    void setupUi(QDialog *edicaopaciente)
    {
        ...
        label_9 = new QLabel(edicaopaciente);
        label_9->setObjectName("label_9");

        horizontalLayout_3->addWidget(label_9);

        txtDiagn = new QLineEdit(edicaopaciente);
        txtDiagn->setObjectName("txtDiagn");

        horizontalLayout_3->addWidget(txtDiagn);
    ...
    void retranslateUi(QDialog *edicaopaciente)
    {
        ...
        label_9->setText(QCoreApplication::translate("edicaopaciente", "Diagn\303\263stico:", nullptr));
